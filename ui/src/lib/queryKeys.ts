export const queryKeys = {
  ...
  companySkills: {
    ...
    shareableTeams: (companyId: string) => ["company-skills", companyId, "shareable-teams"] as const,
  ...
  agents: {
    ...
    mine: (companyId: string) => ["agents", "mine", companyId] as const,
  ...
  leaderboard: (companyId: string, scope: string) => ["leaderboard", companyId, scope] as const,
  bounties: (companyId: string) => ["bounties", companyId] as const,
  ...
  usageRuntimeAccounts: (companyId: string) =>
    ["usage-runtime-accounts", companyId] as const,
