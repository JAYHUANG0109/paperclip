...
export const OFFICE_BADGES: OfficeBadgeInfo[] = [
  ...
  { key: "priority_closer", emoji: "🚨", zh: "重案剋星", en: "Priority Closer", reqZh: "完成 15 項高優先任務", reqEn: "Complete 15 high-priority tasks", xp: 400 },
  ...
  { key: "polymath", emoji: "🧠", zh: "全能通才", en: "Polymath", reqZh: "在 3 個不同專案中完成任務", reqEn: "Complete tasks across 3 different projects", xp: 400 },
