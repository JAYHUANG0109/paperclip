...
export function Dashboard() {
  ...
  // The org-wide summary (spend, all-agent metrics) is admin-only. For a
  // restricted member that 403 is expected — show a calm localized note, not a
  // scary red error — while their own agents still render in the panel below.
  const isRestrictedView = error instanceof ApiError && error.status === 403;
        ...
        <>
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  <p className="text-sm font-medium text-red-50">
                    {t("dashboard.incidents", { count: data.budgets.activeIncidents })}
                  </p>
                  <p className="text-xs text-red-100/70">
                    {t("dashboard.incidentsDetail", { agents: data.budgets.pausedAgents, projects: data.budgets.pausedProjects, approvals: data.budgets.pendingApprovals })}
                  </p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-2 xl:grid-cols-4 gap-1 sm:gap-2">
            ...
            <MetricCard
              ...
              description={
                <span>
                  {t("dashboard.tasksDesc", { open: data.tasks.open, blocked: data.tasks.blocked })}
                </span>
              }
            />
            <MetricCard
              ...
              description={
                <span>
                  {data.budgets.pendingApprovals > 0
                    ? t("dashboard.budgetOverrides", { n: data.budgets.pendingApprovals })
