            ...
            >
              ...
              <div className="flex items-center gap-3 sm:gap-5 mt-4 text-sm text-muted-foreground flex-wrap">
                <div className="flex items-center gap-1.5">
                  ...
                  <span>
                    {agentCount === 1 ? t("companies.agentCount_one", { count: agentCount }) : t("companies.agentCount_other", { count: agentCount })}
                  </span>
                </div>
                <div className="flex items-center gap-1.5">
                  <CircleDot className="h-3.5 w-3.5" />
                  <span>
                    {issueCount === 1 ? t("companies.issueCount_one", { count: issueCount }) : t("companies.issueCount_other", { count: issueCount })}
                  </span>
                </div>
                ...
                >
                  ...
                  <div className="flex items-center gap-2 ml-4 shrink-0">
                    ...
                    <Button
                      ...
                      disabled={deleteMutation.isPending}
                    >
                      {deleteMutation.isPending ? t("companies.deleting") : t("common.delete")}
                    </Button>
                  </div>
                </div>
              )}
