...
export function InstanceAccess() {
  ...
  useEffect(() => {
    setBreadcrumbs([
      { label: t("instanceAccess.breadcrumbSettings"), href: "/instance/settings/general" },
  ...
  const updateCompanyAccessMutation = useMutation({
    ...
    onSuccess: async () => {
      ...
      pushToast({ title: t("instanceAccess.toastCompanyUpdated"), tone: "success" });
    },
  });
  ...
  const setAdminMutation = useMutation({
    ...
    onSuccess: async () => {
      ...
      pushToast({ title: t("instanceAccess.toastRoleUpdated"), tone: "success" });
    },
  });
            ...
            <>
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-end">
                  ...
                  >
                    {updateCompanyAccessMutation.isPending ? t("common.saving") : t("instanceAccess.saveCompanyAccess")}
                  </Button>
                </div>
              </div>
