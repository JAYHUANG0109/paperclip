...
export function CliAuthPage() {
  ...
  if (!challenge) {
    return <div className="mx-auto max-w-xl py-10 text-sm text-destructive">{t("cliAuth.challengeUnavailableShort")}</div>;
  }
      ...
      <div className="mx-auto max-w-xl py-10">
        <div className="rounded-lg border border-border bg-card p-6">
          <h1 className="text-xl font-semibold">
            {challenge.status === "expired" ? t("cliAuth.challengeExpired") : t("cliAuth.challengeCancelled")}
          </h1>
          <p className="mt-2 text-sm text-muted-foreground">
    ...
    <div className="mx-auto max-w-xl py-10">
      <div className="rounded-lg border border-border bg-card p-6">
        ...
        <div className="mt-5 flex gap-3">
          ...
          >
            {approveMutation.isPending ? t("cliAuth.approving") : t("cliAuth.approveAccess")}
          </Button>
          <Button
            type="button"
            variant="outline"
