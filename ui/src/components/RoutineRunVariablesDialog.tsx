    ...
    <Dialog open={open} onOpenChange={(next) => !isPending && onOpenChange(next)}>
      <DialogContent className="flex h-[calc(100dvh-2rem)] max-h-[calc(100dvh-2rem)] max-w-xl flex-col gap-0 overflow-hidden p-0 sm:h-auto sm:max-h-[min(calc(100dvh-2rem),42rem)]">
        <DialogHeader className="shrink-0 border-b border-border/60 px-6 pb-4 pr-12 pt-6">
          ...
          <DialogTitle>{t("routineRun.title")}</DialogTitle>
          <DialogDescription>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-1.5">
              ...
              <InlineEntitySelector
                ...
                placeholder={t("routineRun.agent")}
                noneLabel={t("routineRun.selectAgent")}
                searchPlaceholder={t("routineRun.searchAgents")}
                emptyMessage={t("routineRun.noAgents")}
                disablePortal
                openOnFocus={false}
            ...
            <div className="space-y-1.5">
              ...
              <InlineEntitySelector
                ...
                searchPlaceholder={t("routineRun.searchProjects")}
                emptyMessage={t("routineRun.noProjects")}
                disablePortal
                openOnFocus={false}
                onChange={(projectId) => {
        ...
        >
          {!selection.assigneeAgentId ? (
            ...
            <p className="mr-auto text-xs text-amber-600">
              {t("routineRun.missing", { fields: missingRequired.join(", ") })}
            </p>
          ) : workspaceSelectionEnabled && !workspaceConfigValid ? (
            <p className="mr-auto text-xs text-amber-600">
              {t("routineRun.chooseWorkspace")}
            </p>
          ) : (
          ...
          >
            {isPending ? t("routineRun.running") : t("routineRun.title")}
          </Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
