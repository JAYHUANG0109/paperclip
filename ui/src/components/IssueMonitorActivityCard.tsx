    ...
    <div className="mb-3 rounded-lg border border-border bg-muted/30 px-3 py-2">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <div className="min-w-0">
          <div className="text-sm font-medium text-foreground">{t("issueMonitorActivity.scheduled")}</div>
          <div className="text-xs text-muted-foreground">
            {t("issueMonitorActivity.nextCheck", {
          ...
          {monitor.attemptCount > 0 ? (
            <div className="mt-1 text-xs text-muted-foreground">{t("issueMonitorActivity.attempt", { count: monitor.attemptCount })}</div>
          ) : null}
        </div>
        {onCheckNow ? (
          <Button
          ...
          >
            {checkingNow ? t("common.checking") : t("issueMonitorActivity.checkNow")}
          </Button>
        ) : null}
      </div>
    </div>
