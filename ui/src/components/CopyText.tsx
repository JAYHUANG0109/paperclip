...
export function CopyText({
  ...
  const handleClick = useCallback(async () => {
    try {
      // copyTextToClipboard now owns both halves of what this used to inline:
      // the secure-context gate and the off-screen-textarea execCommand fallback
      // for HTTP on a non-localhost host.
