...
export const FLOORS: FloorDef[] = [
  {
    ...
    zones: [
      ...
      { id: "it", name: "資訊部", team: "資訊部", x: 34.4, y: 1.8, w: 32.3, h: 32.1, color: "#3B82F6", seats: [{"x":39.65,"y":13.61},{"x":46.91,"y":13.61},{"x":54.17,"y":13.61},{"x":61.42,"y":13.61},{"x":43.28,"y":26.55},{"x":50.54,"y":26.55},{"x":57.8,"y":26.55}] },
      ...
      { id: "talent", name: "人發部", team: "人發部", x: 34.4, y: 35.7, w: 32.3, h: 32.1, color: "#6366F1", seats: [{"x":43.28,"y":47.54},{"x":57.8,"y":47.54}] },
