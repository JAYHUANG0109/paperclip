...
export const FLOORS: FloorDef[] = [
  {
    ...
    natH: 896,
    zones: [
      { id: "teaching", name: "教學組", team: "教學組", x: 1.1, y: 1.8, w: 32.3, h: 32.1, color: "#8B5CF6", seats: [{"x":6.32,"y":13.61},{"x":13.58,"y":13.61},{"x":20.83,"y":13.61},{"x":28.09,"y":13.61},{"x":6.32,"y":22.24},{"x":13.58,"y":22.24},{"x":20.83,"y":22.24},{"x":28.09,"y":22.24},{"x":17.2,"y":30.87}] },
      { id: "it", name: "數位資訊部", team: "數位資訊部", x: 34.4, y: 1.8, w: 32.3, h: 32.1, color: "#3B82F6", seats: [{"x":39.65,"y":13.61},{"x":46.91,"y":13.61},{"x":54.17,"y":13.61},{"x":61.42,"y":13.61},{"x":43.28,"y":26.55},{"x":50.54,"y":26.55},{"x":57.8,"y":26.55}] },
      { id: "esl", name: "ESL教學組", team: "ESL教學組", x: 67.7, y: 1.8, w: 31.2, h: 32.1, color: "#14B8A6", seats: [{"x":72.85,"y":13.61},{"x":79.84,"y":13.61},{"x":86.83,"y":13.61},{"x":93.82,"y":13.61},{"x":83.33,"y":26.55}] },
      { id: "lead", name: "園長團隊", team: "領導團隊", x: 1.1, y: 35.7, w: 32.3, h: 32.1, color: "#F59E0B", seats: [{"x":7.53,"y":47.54},{"x":17.2,"y":47.54},{"x":26.88,"y":47.54}] },
      { id: "talent", name: "人才發展部", team: "人才發展部", x: 34.4, y: 35.7, w: 32.3, h: 32.1, color: "#6366F1", seats: [{"x":43.28,"y":47.54},{"x":57.8,"y":47.54}] },
      { id: "ga", name: "總務管理組", team: "總務管理組", x: 67.7, y: 35.7, w: 31.2, h: 32.1, color: "#EC4899", seats: [{"x":76.34,"y":47.54},{"x":90.32,"y":47.54}] },
      { id: "brand", name: "品牌發展部", team: "品牌發展部", x: 1.1, y: 69.6, w: 32.3, h: 28.6, color: "#F43F5E", seats: [{"x":17.2,"y":81.46}] },
      { id: "founder", name: "創辦人辦公室", team: null, x: 34.4, y: 69.6, w: 32.3, h: 28.6, color: "#A855F7", soloAgent: "創辦人", seats: [{"x":50.54,"y":85.54}] },
      { id: "auto", name: "系統自動化", team: "系統自動化", x: 67.7, y: 69.6, w: 31.2, h: 28.6, color: "#F97316", seats: [{"x":76.34,"y":81.46},{"x":90.32,"y":81.46}] },
    ],
  },
];
