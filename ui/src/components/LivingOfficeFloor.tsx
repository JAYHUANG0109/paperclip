...
export const FLOORS: FloorDef[] = [
  {
    ...
    zones: [
      ...
      { id: "esl", name: "ESL主管", team: "ESL主管", x: 67.7, y: 1.8, w: 31.2, h: 32.1, color: "#14B8A6", seats: [{"x":72.85,"y":13.61},{"x":79.84,"y":13.61},{"x":86.83,"y":13.61},{"x":93.82,"y":13.61},{"x":83.33,"y":26.55}] },
