    ...
    <CommandDialog open={open} onOpenChange={(v) => {
      ...
      <CommandList>
        <CommandEmpty>
          {showSearchAll ? (
            <span>
              {t("commandPalette.noQuickMatches")}{" "}
              <kbd className="rounded border border-border bg-muted px-1 py-0.5 text-(length:--text-nano)">↵</kbd>{" "}
              {t("commandPalette.toSearchAllPrefix")} <span className="font-medium">{t("commandPalette.searchAllEmphasis")}</span> {t("commandPalette.toSearchAllSuffix")}
            </span>
          ) : (
        ...
        {showSearchAll ? (
          <CommandGroup heading={t("commandPalette.searchHeading")}>
            <CommandItem
        ...
        <CommandGroup heading={t("commandPalette.quickFiltersHeading")}>
        ...
        <CommandGroup heading={t("commandPalette.pagesHeading")}>
