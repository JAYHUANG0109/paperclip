            ...
            >
              <div className="min-w-0">
                ...
                <div className="text-xs text-muted-foreground">
                  {row.eventCount === 1 ? t("financeKindCard.eventCount_one", { count: row.eventCount }) : t("financeKindCard.eventCount_other", { count: row.eventCount })}
                  {" · "}
                  {row.billerCount === 1 ? t("financeKindCard.billerCount_one", { count: row.billerCount }) : t("financeKindCard.billerCount_other", { count: row.billerCount })}
                </div>
              </div>
