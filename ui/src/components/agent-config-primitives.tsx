...
const HELP_KEYS = [
  ...
  "maxTurnContinuationMaxAttempts",
  "maxTurnContinuationDelaySec",
  "budgetMonthlyCents",
] as const;

// Resolve help text lazily on access so language changes are reflected.
export const help: Record<string, string> = new Proxy(
  {},
  {
    get(_target, prop: string) {
      return t(`agentConfigHelp.${prop}`);
    },
    has(_target, prop: string) {
      return (HELP_KEYS as readonly string[]).includes(prop);
    },
    ownKeys() {
      return [...HELP_KEYS];
    },
        ...
        <DialogContent>
          ...
          <div className="space-y-4 text-sm">
            <section className="space-y-1.5">
              <p className="font-medium">{t("choosePath.macosHeading")}</p>
              <ol className="list-decimal space-y-1 pl-5 text-muted-foreground">
                <li>{t("choosePath.macosStep1")}</li>
                <li>{t("choosePath.macosStep2Pre")} <kbd>Option</kbd> {t("choosePath.macosStep2Post")}</li>
                <li>{t("choosePath.macosStep3")}</li>
                <li>{t("choosePath.pasteResult")}</li>
              </ol>
            ...
            <section className="space-y-1.5">
              <p className="font-medium">{t("choosePath.windowsHeading")}</p>
              <ol className="list-decimal space-y-1 pl-5 text-muted-foreground">
                <li>{t("choosePath.windowsStep1")}</li>
                <li>{t("choosePath.windowsStep2Pre")} <kbd>Shift</kbd> {t("choosePath.windowsStep2Post")}</li>
            ...
            <section className="space-y-1.5">
              <p className="font-medium">{t("choosePath.terminalHeading")}</p>
              <ol className="list-decimal space-y-1 pl-5 text-muted-foreground">
                <li>{t("choosePath.terminalStep1Pre")} <code>cd /path/to/folder</code>.</li>
                <li>{t("choosePath.terminalStep2Pre")} <code>pwd</code>.</li>
