  ...
  return (
    <>
      ...
      {collectingDownvoteReason ? (
        <div className="mt-2 rounded-md border border-border/60 bg-accent/20 p-3">
          ...
          <Textarea
            ...
            placeholder={t("feedback.addNote")}
          ...
          <div className="mt-3 flex items-center justify-end gap-2">
            ...
            >
              {isSaving ? t("common.saving") : t("feedback.saveNote")}
            </Button>
          </div>
        </div>
      ) : null}
      ...
      >
        <DialogContent>
          <DialogHeader>
            <DialogTitle>{t("feedback.prefTitle")}</DialogTitle>
            <DialogDescription>
              {t("feedback.prefDesc")}
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-3 text-sm text-muted-foreground">
            <p>
              {t("feedback.savedLocally")}
            </p>
            <p>
              {t("feedback.prefExplain")}
            </p>
            <p>
          ...
          <DialogFooter>
            ...
            >
              {isSaving ? t("common.saving") : t("feedback.dontAllow")}
            </Button>
            <Button
              type="button"
              disabled={!pendingVote || isSaving}
            ...
            >
              {isSaving ? t("common.saving") : t("feedback.alwaysAllow")}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
