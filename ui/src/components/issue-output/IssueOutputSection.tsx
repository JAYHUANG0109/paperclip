...
export function IssueOutputSection({ workProducts, resolveCreatorName }: IssueOutputSectionProps) {
  ...
  return (
    <section className="space-y-3" aria-label={t("issueOutput.taskOutputs", { defaultValue: "Task outputs" })}>
      <div className="flex items-center gap-2">
        <Play className="h-3.5 w-3.5 text-muted-foreground" aria-hidden="true" />
        <h3 className="text-sm font-medium text-muted-foreground">{t("issueOutput.output", { defaultValue: "Output" })}</h3>
