...
export const issues = pgTable(
  "issues",
  {
    ...
    // True when the server derived the title from the description because none
    // was written. The assigned agent replaces such a title with a real summary
    // on its first run; a deliberately chosen title is left alone.
    titleAutoGenerated: boolean("title_auto_generated").notNull().default(false),
