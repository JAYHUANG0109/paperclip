...
const KANS = [
  ...
  { key: "skills-routines", title: "關卡 5｜上傳一個你喜歡的技能", desc: "教學：技能（Skills）＝會依情境自動觸發的招式。到「技能」頁按「＋ 新增」上傳一個你喜歡的 SKILL.md（或用 GitHub／範本），並選存取範圍（公開／團隊〔校區×部門〕／私人）。完成條件：真的建立了一個你自己的技能。" },
] as const;
